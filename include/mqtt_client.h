...
#ifndef MCUSERVICE_MQTT_CLIENT_H
#define MCUSERVICE_MQTT_CLIENT_H
...
private:
    ...
    int keepalive_ = 60;
    // 客户端ID
    std::string client_id_ = "McuService";
    // 用户名
    std::string username_ = "McuService";
    // 密码
    std::string password_ = "McuService";
    // 使用SSL
    bool use_ssl_ = false;
    // 订阅主题
...
#endif //MCUSERVICE_MQTT_CLIENT_H